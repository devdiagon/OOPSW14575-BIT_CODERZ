 ...
 * @author Frederick
 */
public class FrmAddPenaltyFee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTipoMulta = new javax.swing.JLabel();
        ...
        txtTitle.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.txtTitle.text")); // NOI18N
        background.add(txtTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 21, -1, -1));
        ...
        sptTitle.setPreferredSize(new java.awt.Dimension(216, 1));
        background.add(sptTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 49, -1, -1));

        txtCosto.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        txtCosto.setForeground(new java.awt.Color(135, 132, 132));
        txtCosto.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.txtCosto.text")); // NOI18N
        background.add(txtCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 228, -1, -1));

        txtTipoMulta.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        txtTipoMulta.setForeground(new java.awt.Color(135, 132, 132));
        txtTipoMulta.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.txtTipoMulta.text")); // NOI18N
        background.add(txtTipoMulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 79, -1, -1));

        tfdType.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        tfdType.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.tfdType.text")); // NOI18N
        ...
        fdlCost.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.fdlCost.text_1")); // NOI18N
        background.add(fdlCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 228, 100, -1));
        ...
        background.add(sptCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, -1, -1));
        ...
        txtConfirmbtn.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.txtConfirmbtn.text")); // NOI18N
        ...
        background.add(btnConfirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 120, 40));

        txtDescripcion.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        txtDescripcion.setForeground(new java.awt.Color(135, 132, 132));
        txtDescripcion.setText(org.openide.util.NbBundle.getMessage(FrmAddPenaltyFee.class, "FrmAddPenaltyFee.txtDescripcion.text")); // NOI18N
        background.add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 130, -1, -1));

        txaDescription.setColumns(20);
        txaDescription.setFont(new java.awt.Font("Inter", 0, 12)); // NOI18N
        txaDescription.setRows(5);
        txaDescription.setBorder(null);
        jScrollPane1.setViewportView(txaDescription);

        background.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, -1, -1));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(background, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void sendPenaltyFeeData(){
        String insertedType = tfdType.getText();
        String insertedDescription = txaDescription.getText();
        float insertedCost = HandleInput.returnFloat(fdlCost.getText());
        
        penaltyFee = new PenaltyFee(insertedDescription, insertedType, insertedCost);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAddPenaltyFee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAddPenaltyFee().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel txtTipoMulta;
